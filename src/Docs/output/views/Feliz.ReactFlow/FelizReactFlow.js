...
import { funcToTuple, ReactContentLoader } from "../../Feliz.ReactContentLoader/Interop.js";
import { ArrowHead, ArrowHead__get_Value, EdgeType, EdgeType__get_Value, NodeType, NodeType__get_Value } from "../../Feliz.ReactContentLoader/Types.js";
...
}, Interop_reactApi.createElement(ReactContentLoader, {
    elements: [(() => {
...
export const overview = (() => {
    let elms;
    const children_2 = ofArray([(elms = ofArray(["Feliz.ReactContentLoader - Documentation", createElement("a", {
        href: "https://www.nuget.org/packages/Feliz.ReactContentLoader/",
        children: Interop_reactApi.Children.toArray([createElement("img", {
            src: "https://img.shields.io/nuget/v/Feliz.ReactContentLoader.svg?style=flat",
        })]),
    })]), createElement("h1", {
        ...
        children: Interop_reactApi.Children.toArray(["Feliz bindings for ReactContentLoader."]),
    }), createElement("hr", {}), fixDocsView("FelizReactContentLoader", false)]);
    return createElement("div", {
        children: Interop_reactApi.Children.toArray(Array.from(children_2)),
    });
})();

export const installation = installationView("Feliz.ReactContentLoader");
