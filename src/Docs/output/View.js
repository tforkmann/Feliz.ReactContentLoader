...
import { ReactContentLoaderView } from "./Pages/ReactContentLoaderView.js";
...
function leftSide(p) {
    ...
    const children_8 = ofArray([createElement("label", createObj(Helpers_combineClasses("drawer-overlay", singleton(["htmlFor", "main-menu"])))), createElement("aside", createObj(ofArray([["className", "flex flex-col border-r w-80 bg-base-100 text-base-content"], (elems_5 = [(elm = ofArray([createElement("span", {
        ...
        children: "Feliz.ReactContentLoader",
    }), createElement("a", createObj(ofArray([["href", "https://www.nuget.org/packages/Feliz.ReactContentLoader"], (elems_2 = [createElement("img", {
        src: "https://img.shields.io/nuget/v/Feliz.ReactContentLoader.svg?style=flat-square",
        ...
        children: Interop_reactApi.Children.toArray(Array.from(children_5)),
    })), mi("Install", new Page(0, [])), mi("Use", new Page(1, [])), mi("ReactContentLoader", new Page(2, []))], ["children", Interop_reactApi.Children.toArray(Array.from(elems_4))])]))))], ["children", Interop_reactApi.Children.toArray(Array.from(elems_5))])])))]);
    return createElement("div", {
...
export function AppView(appViewInputProps) {
    ...
    patternInput = ((matchValue.tag === 1) ? ["How to use", "/docs/use", createElement(UseView, null)] : ((matchValue.tag === 2) ? ["ReactContentLoader", "/reactcontentloader", createElement(ReactContentLoaderView, null)] : ["Installation", "/docs/install", createElement(InstallView, null)]));
