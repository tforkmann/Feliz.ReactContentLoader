...
export function EdgeType$reflection() {
    return union_type("Feliz.ReactContentLoader.EdgeType", [], EdgeType, () => [[], [], [], []]);
}
...
export function ArrowHead$reflection() {
    return union_type("Feliz.ReactContentLoader.ArrowHead", [], ArrowHead, () => [[], []]);
}
...
export function NodeType$reflection() {
    return union_type("Feliz.ReactContentLoader.NodeType", [], NodeType, () => [[], [], []]);
}
...
export function position$reflection() {
    return record_type("Feliz.ReactContentLoader.position", [], position, () => [["x", int32_type], ["y", int32_type]]);
}
